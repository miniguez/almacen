...
class BootButtonColumn extends CButtonColumn
{
	...
	public $deleteButtonIcon = 'trash';
        ...
        /**
         *
         * @var string the add button icon
         */
        public $addButtonIcon = 'plus-sign';

        public $passButtonIcon= 'lock';

        public $activeButtonIcon='thumbs-up';

        public $inactiveButtonIcon='thumbs-down';
	...
	protected function initDefaultButtons()
	{
        ...
        if ($this->passButtonIcon !== false && !isset($this->buttons['pass']['icon']))
            $this->buttons['pass']['icon'] = $this->passButtonIcon;
        if ($this->activeButtonIcon !== false && !isset($this->buttons['active']['icon']))
            $this->buttons['active']['icon'] = $this->activeButtonIcon;
        if ($this->inactiveButtonIcon !== false && !isset($this->buttons['inactive']['icon']))
            $this->buttons['inactive']['icon'] = $this->inactiveButtonIcon;
	}
